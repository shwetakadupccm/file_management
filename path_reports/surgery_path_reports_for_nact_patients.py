...
patient_names_df = pd.read_excel('D:/Shweta/nact_data/nact_patients/2021_09_20_final_data_NACT_dk_sk.xlsx')
...
jeh_reports = os.listdir('D:/Shweta/email/attachments_from_jehangir/all_jehangir/pdf_files')
ruby_hall_reports = os.listdir('D:/Shweta/email/attachments_from_ruby_hall/all_ruby_hall/pdf_files')
...
def clean_report_name(folder_path):
    ...
    for report in path_reports:
        ...
        cleaned_report_name = cleaned_report_name.strip()
...
def match_copy_nact_patients_reports(patient_list_df, source_path, destination_path):
    ...
    for patient_name in patient_list_df['patient_name']:
        ...
        print(patient_name)
        match_name = process.extractOne(patient_name, path_reports_cleaned, scorer=fuzz.token_sort_ratio, score_cutoff=50)
...
output_df = match_copy_nact_patients_reports(patient_names_df, 'D:/Shweta/email/attachments_from_ruby_hall/all_ruby_hall/pdf_files',
                                 'D:/Shweta/nact_data/nact_path_reports/ruby_reports')

output_df.to_excel('D:/Shweta/nact_data/nact_path_reports/output_df/2021_10_25_matched_nact_patient_report_ruby_sk.xlsx',
                   index=False)
##
