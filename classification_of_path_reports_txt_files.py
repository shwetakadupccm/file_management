...
name = get_patient_name_from_report(lines, cleaned_file_name1)

def get_patient_name_surgery_date(file, keyword = 'chemotherapy'):
...
key_word_info = get_patient_name_surgery_date(file, keyword = 'chemotherapy')
...
##
def get_keyword_info(folder_path, string = 'chemotherapy'):
...
keyword_info_new = get_keyword_info(folder_path, string = 'chemotherapy')
...
def read_file_info_from_report(folder_path, date_str = 'sc date'):
    ...
    for file_name in file_names:
        ...
        patient_name = get_patient_name_from_report(file_text_lst, file_name)
        print(patient_name)
        sc_date = get_sc_date(file_text_lst, date_str)
        print(sc_date)
